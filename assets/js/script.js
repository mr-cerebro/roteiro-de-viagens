...
const atividade = {
  nome: "Almoço",
  data: new Date("2024-07-27 23:39"),
  finalizada: false,
};
...
let atividades = [
  atividade,
  {
    ...
    data: new Date("2024-07-27 23:50"),
    finalizada: true,
  },
  {
    nome: "Gaming session",
    data: new Date("2024-07-28 01:06"),
    finalizada: false,
  },
];
...
const criarItemDeAtividade = (atividade) => {
  ...
  return `
    <div class="card-bg">
        ...
        <div>
          <svg class="ative" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
